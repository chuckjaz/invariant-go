...
func (s *CachingStorage) BatchHas(ctx context.Context, addresses []string) ([]string, error) {
	var missing []string
...
func (s *CachingStorage) BatchStore(ctx context.Context, blocks map[string]io.Reader) error {
