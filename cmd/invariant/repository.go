...
func runRepository(globalCfg *config.InvariantConfig, args []string) {
	if len(args) < 1 {
		...
		fmt.Fprintf(os.Stderr, " Primary workflow\n")
		...
		fmt.Fprintf(os.Stderr, "  submit       Push changes upstream and retire workspace\n")
		fmt.Fprintf(os.Stderr, "  show         Inspect a commit or view a file snapshot\n")
		fmt.Fprintf(os.Stderr, "\n")
		fmt.Fprintf(os.Stderr, " Initialization and configuration\n")
		fmt.Fprintf(os.Stderr, "  create       Create a new repository and initialize main branch\n")
		fmt.Fprintf(os.Stderr, "  open         Open an existing repository\n")
		fmt.Fprintf(os.Stderr, "  config       Get, set, list, or unset repository or user settings\n")
		fmt.Fprintf(os.Stderr, "\n")
		fmt.Fprintf(os.Stderr, " Branch management\n")
		...
		fmt.Fprintf(os.Stderr, "\n")
		fmt.Fprintf(os.Stderr, " Workspace management\n")
		...
		fmt.Fprintf(os.Stderr, "  grep         Search for patterns in commit trees\n")
		fmt.Fprintf(os.Stderr, "  bisect       Binary search across history to locate regressions\n")
		fmt.Fprintf(os.Stderr, "\n")
		fmt.Fprintf(os.Stderr, " Input/Export\n")
